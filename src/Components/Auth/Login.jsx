...
//   const [userProfile, setUserProfile] = useState(null);
  ...
  useEffect(() => {
    ...
    if (authTokens) {
      ...
      {decodedUser.is_patient && navigate('/patient/dashboard')}
      {decodedUser.is_doctor && navigate('/doctor/dashboard')}
      {decodedUser.is_staff && navigate('/dashboard')}
    }
  }, [authTokens]);
  ...
  <div className="mb-3">
    ...
    <p>Arleady have an  account? <Link to='/signup'>Sign up</Link></p>
  </form>
</div>
    </div>
